...
var CoSupervisorRequest = require('../models/cosupervisorRequests.model'); //create co-supervisor request
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          ...
          _context6.prev = 1;
          _context6.next = 4;
          return regeneratorRuntime.awrap(CoSupervisorRequest.findOneAndDelete({
            groupId: groupId
          }));
